...
export const mockReviews: Review[] = [
    {
        ...
        service_id: 'service-1',
        rating: 5,
        comment: 'Chioma is absolutely amazing! My wedding makeup was flawless. Every guest kept complimenting me throughout the night.',
        created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
        reviewer_name: 'Adaeze Okonkwo',
        reviewer_avatar: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=100&h=100&auto=format&fit=crop',
    },
    {
        id: 'review-2',
        ...
        service_id: 'service-1',
        rating: 5,
        comment: 'Best bridal makeup I have ever seen. She understood my vision perfectly and the products lasted all day.',
        created_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
        reviewer_name: 'Fatima Al-Hassan',
        reviewer_avatar: 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?q=80&w=100&h=100&auto=format&fit=crop',
    },
    {
        id: 'review-3',
        ...
        service_id: 'service-1',
        rating: 4,
        comment: 'Very professional and punctual. The look was stunning. Slight delay at the start but everything was worth it.',
        created_at: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(),
        reviewer_name: 'Blessing Eze',
        reviewer_avatar: 'https://images.unsplash.com/photo-1531123414780-f74242c2b052?q=80&w=100&h=100&auto=format&fit=crop',
    },
    {
        id: 'review-4',
        ...
        rating: 5,
        comment: 'The evening glam look she created was absolutely breathtaking. Got so many compliments at the gala!',
        created_at: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000).toISOString(),
        reviewer_name: 'Ngozi Ibe',
        reviewer_avatar: 'https://images.unsplash.com/photo-1589156229687-496a31ad1d1f?q=80&w=100&h=100&auto=format&fit=crop',
    },
    {
        id: 'review-5',
        ...
        service_id: 'service-3',
        rating: 5,
        comment: 'Oluwaseun installed my wig perfectly. The lace was completely invisible and the styling was chef\'s kiss.',
        created_at: new Date(Date.now() - 20 * 24 * 60 * 60 * 1000).toISOString(),
        reviewer_name: 'Kemi Adeyemi',
        reviewer_avatar: 'https://images.unsplash.com/photo-1523824921871-d6f1a15151f1?q=80&w=100&h=100&auto=format&fit=crop',
    },
];
